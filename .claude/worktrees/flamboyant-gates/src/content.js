...
export const content = {
  bg: {
    ...
    badge: "Поп-фолк радио онлайн, 24/7",
    heroTitle: "Пусни музиката — поп-фолк, фолклор и балкански ритми, денонощно.",
    heroText:
      "Фолк Радио Наздраве е интернет радио от София, създадено през 2005 година от трима приятели, тогава студенти. Станцията излъчва поп-фолк, българска народна и балканска музика денонощно, а тази уеб версия прави достъпа до радиото по-лесен и по-ясен на всяко устройство.",
    heroPrimary: "Слушай на живо",
    heroSecondary: "Историята на радиото",
    cardLiveValue: "24/7",
    cardLive: "Излъчване",
    cardYearsValue: "20+",
    cardYears: "Години в ефир",
    cardLanguagesValue: "BG + EN",
    cardLanguages: "Езици",
    cardDevicesValue: "100%",
    cardDevices: "Отзивчив дизайн",
    cardAccessibilityValue: "A11Y",
    ...
    playerDescription: “Едно натискане и музиката потича.”,
    retry: “Опитай отново”,
    play: "Пусни",
    pause: "Пауза",
    mute: "Без звук",
    ...
    testimonialsIntro:
      "Гласове от общността на Фолк Радио Наздраве.",
    testimonials: [
      {
        quote:
    ...
    shortcuts: [
      { key: "Space", action: "пускане / пауза" },
      { key: "M", action: "спиране / пускане на звука" },
      { key: "\u2191", action: "увеличаване на звука" },
      { key: "\u2193", action: "намаляване на звука" },
    ],
    ...
    youtube: "YouTube",
    tiktok: "TikTok",
    footer: "© 2005–2025 Фолк Радио Наздраве. Всички права запазени.",
  },
  en: {
    htmlLang: "en",
    ...
    badge: "Online pop-folk radio, 24/7",
    heroTitle: "Turn up the music. Pop-folk, folk, and Balkan sounds streaming live, 24/7.",
    heroText:
      "Folk Radio Nazdrave is an internet radio station from Sofia, founded in 2005 by three friends. The station streams pop-folk, Bulgarian folk, and Balkan music around the clock. This updated web app brings the sound closer to you — clear, fast, and accessible on any device.",
    heroPrimary: "Listen live",
    heroSecondary: "Our story",
    cardLiveValue: "24/7",
    cardLive: "Live stream",
    cardYearsValue: "20+",
    cardYears: "Years on air",
    cardLanguagesValue: "BG + EN",
    cardLanguages: "Languages",
    cardDevicesValue: "100%",
    cardDevices: "Responsive",
    cardAccessibilityValue: "A11Y",
    cardAccessibility: "Accessible",
    selectStation: "Choose station",
    liveNow: "Now playing",
    nowPlayingFallback: "Folk Radio Nazdrave Live",
    nowPlayingEmpty: "Loading current track details...",
    playerDescription: "One tap. Music flows.",
    retry: "Try again",
    play: "Play",
    pause: "Pause",
    mute: "Mute",
    ...
    testimonialsIntro:
      "Voices from the Folk Radio Nazdrave community.",
    testimonials: [
      {
        quote:
    ...
    shortcuts: [
      ...
      { key: "\u2191", action: "raise volume" },
      { key: "\u2193", action: "lower volume" },
    ],
    ...
    youtube: "YouTube",
    tiktok: "TikTok",
    footer: "© 2005–2025 Folk Radio Nazdrave. All rights reserved.",
  },
};
